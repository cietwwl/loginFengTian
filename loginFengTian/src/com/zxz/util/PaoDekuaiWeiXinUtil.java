...
public class PaoDekuaiWeiXinUtil {

	private static Logger logger = Logger.getLogger(PaoDekuaiWeiXinUtil.class);  
	
	static final String appid = "wx43ced93e1410cd89";//璺戠殑蹇�
	static final String appsecret = "f8451f36a9ceea94ca69c6aa0620040e";//璺戠殑蹇�
...
//		System.out.println("userInfo:"+userInfo);
		String accessToken = PaoDekuaiWeiXinUtil.getAccessTokenWithRefreshToken("Ajc0EXxE_28PebMcoqzyRHWmtSNlAmCLTskDHVzpWaPZJttSe6Si2nB5LyHVX2uSzfCTNAMqh7qNhOEPDgBGrz1W4O_zq6zkQ-1i2ZfkXEo");
...
//		String returnStr = httpRequest(url, "POST", null);
		String returnStr = sendPost(url, null);
		logger.info("妫�獙鎺堟潈鍑瘉锛坅ccess_token锛夋槸鍚︽湁鏁�"+returnStr);
